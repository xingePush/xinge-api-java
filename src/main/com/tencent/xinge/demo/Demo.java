...
public class Demo {
  ...
  protected JSONObject demoPushAccountListMultiple() {
    ...
    if (ret.getInt("ret_code") != 0)
      ...
      // ...
      result.append("all", xinge
          .pushAccountListMultiple(ret.getJSONObject("result").getLong("push_id"), accountList1));
      ...
      // ...
      result.append("all", xinge
          .pushAccountListMultiple(ret.getJSONObject("result").getLong("push_id"), accountList2));
      return result;
    }
  }
  ...
  protected JSONObject demoPushDeviceListMultiple() {
    ...
    if (ret.getInt("ret_code") != 0)
      ...
      // ...
      result.append("all", xinge
          .pushDeviceListMultiple(ret.getJSONObject("result").getLong("push_id"), deviceList1));
      ...
      // ...
      result.append("all", xinge
          .pushDeviceListMultiple(ret.getJSONObject("result").getLong("push_id"), deviceList2));
      return result;
    }
  }
